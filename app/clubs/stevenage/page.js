...
export default function StevenagePage() {
  const clubData = {
    ...
    nickname: 'The Boro',
    founded: 1976,
    stadium: 'Lamex Stadium (Broadhall Way)',
    capacity: '6,722',
    location: 'Stevenage, Hertfordshire',
    league: 'League One',
    recordSigning: { player: 'Charlie Goode', fee: 'Undisclosed', year: 2015, from: 'Scunthorpe United' },
    recordSale: { player: 'Ben Wilmot', fee: 'Undisclosed', year: 2018, to: 'Watford' },
    topScorer: { name: 'Martin Gittings', goals: 217, years: '1980-1995' },
    mostAppearances: { name: 'Ronnie Henry', apps: 502, years: '2000-2013' },
    honours: [
      { title: 'FA Trophy Winners', years: ['2006-07', '2008-09'] },
      { title: 'Conference Premier Champions', years: ['2009-10'] },
      { title: 'League Two Play-off Winners', years: ['2010-11'] },
      { title: 'League Two Champions', years: ['2022-23'] },
      { title: 'Isthmian League Premier Division Champions', years: ['1993-94'] },
      { title: 'Isthmian League Division One Champions', years: ['1990-91'] }
    ],
    history: {
      founding: "Formed in 1976 as Stevenage Borough following the bankruptcy of Stevenage Athletic. After the council sold Broadhall Way, the club played at King George V playing fields before returning to Broadhall Way in 1980. The club joined the United Counties Football League in 1980 and progressed through the non-league pyramid.",
      goldenEra: "Stevenage's greatest achievement came in 2007 when they became the first team to win a competitive final at the new Wembley Stadium, defeating Kidderminster Harriers 3-2 in the FA Trophy in front of 53,262 fans. They won the FA Trophy again in 2009 and earned promotion to the Football League in 2010 after winning the Conference.",
      modernEra: "In their third consecutive League One season (2025-26), celebrating 50 seasons of existence. The club achieved consecutive promotions in 2010 and 2011, reaching League One for the first time. After relegation in 2014, they spent time in League Two before earning promotion back to League One as champions in 2022-23.",
      notable: "Stevenage produced one of the great FA Cup giant-killings, holding Premier League Newcastle United to a 1-1 draw at Broadhall Way in 1998 (lost 2-1 in replay). They also reached the fourth round again in 1997-98 and 2011-12. The club dropped 'Borough' from its name in 2010 to become simply Stevenage FC."
    }
  };
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-lg">
                <span className="text-3xl font-bold text-red-600">SFC</span>
              </div>
              <div>
                <h1 className="text-5xl font-bold text-white">{clubData.name}</h1>
                <p className="text-red-200 text-xl mt-2">{clubData.nickname}</p>
                <p className="text-slate-300 text-sm mt-1 italic">50th Season (2025-26)</p>
              </div>
            </div>
            <button
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          ...
          <div className="bg-slate-800 rounded-lg p-6 border border-slate-700">
            ...
            <p className="text-white text-xs font-bold">{clubData.stadium}</p>
          </div>
          <div className="bg-slate-800 rounded-lg p-6 border border-slate-700">
        ...
        <section className="bg-slate-800 rounded-xl p-8 border border-slate-700 mb-8">
          ...
          <div className="space-y-6 text-slate-300 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-bold text-white mb-3">The Wembley Glory (2007-2010)</h3>
