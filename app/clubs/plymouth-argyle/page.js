...
export default function PlymouthPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <header className="bg-gradient-to-r from-green-900/50 to-slate-700/50 backdrop-blur-sm border-b border-green-700">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-green-200 text-xl mt-2">{clubData.nickname}</p>
              </div>
            </div>
            <button
