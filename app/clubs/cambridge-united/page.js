...
export default function CambridgeUnitedPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50 to-white">
      <header className="bg-gradient-to-r from-amber-500 to-yellow-400 text-black border-b-4 border-black shadow-lg">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-black text-xl mt-2">{clubData.nickname}</p>
                <p className="text-slate-800 text-sm mt-1 italic">{clubData.season} Season - League Two</p>
              </div>
            </div>
            <button
              onClick={() => window.location.href = '/clubs'}
              className="px-6 py-3 bg-black hover:bg-slate-800 text-amber-400 rounded-lg transition-colors"
            >
              Back to Clubs
            </button>
          </div>
