...
export default function BromleyPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-slate-100 to-slate-200">
      <header className="bg-gradient-to-r from-white/90 to-slate-100/90 backdrop-blur-sm border-b-4 border-black">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-700 text-xl mt-2">{clubData.nickname}</p>
                <p className="text-slate-600 text-sm mt-1 italic">Football League History Makers (2024)</p>
              </div>
            </div>
            <button
