...
export default function DoncasterRoversFC() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-800 via-white to-red-800">
      <header className="bg-gradient-to-r from-red-800 to-white text-red-800 border-b-4 border-red-800 shadow-lg">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-lg border-4 border-red-800">
                <span className="text-2xl font-bold text-red-800">DRFC</span>
              </div>
              <div>
                <h1 className="text-5xl font-bold text-red-800">{clubData.name}</h1>
                <div className="flex items-center mt-2">
                  <p className="text-red-600 text-xl">{clubData.nickname}</p>
                  <span className="ml-3 px-3 py-1 bg-red-600 text-white rounded-full text-xs font-bold">
                    {clubData.status}
                  </span>
                </div>
                <p className="text-red-600 text-sm mt-1 italic">Competing in League One</p>
              </div>
            </div>
            <button
              onClick={() => window.location.href = '/clubs'}
              className="px-6 py-3 bg-red-800 hover:bg-red-900 text-white rounded-lg transition-colors font-bold shadow-md"
            >
              Back to Clubs
            </button>
          </div>
