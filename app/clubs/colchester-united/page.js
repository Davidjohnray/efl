...
export default function ColchesterUnitedPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-white to-blue-900">
      <header className="bg-gradient-to-r from-blue-600 to-blue-500 text-white border-b-4 border-blue-700 shadow-lg">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-blue-100 text-xl mt-2">{clubData.nickname}</p>
                <p className="text-blue-100 text-sm mt-1 italic">{clubData.season} Season - League Two</p>
              </div>
            </div>
            <button
              onClick={() => window.location.href = '/clubs'}
              className="px-6 py-3 bg-white hover:bg-blue-50 text-blue-600 rounded-lg transition-colors font-bold"
            >
              Back to Clubs
            </button>
          </div>
