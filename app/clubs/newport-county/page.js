...
export default function NewportCountyAFC() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-900 via-black to-amber-900">
      <header className="bg-gradient-to-r from-black to-amber-800 text-white border-b-4 border-amber-500 shadow-lg">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-amber-300 text-sm mt-1 italic">{clubData.season} Season - League Two</p>
              </div>
            </div>
            <button
              onClick={() => window.location.href = '/clubs'}
              className="px-6 py-3 bg-amber-500 hover:bg-amber-400 text-black rounded-lg transition-colors font-bold shadow-md"
            >
              Back to Clubs
            </button>
          </div>
